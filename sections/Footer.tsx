...
export default function Footer({
  ...
  //       bcc: [],
  //       from: "onboarding@resend.dev",
  //       text: `Nome: ${nome}, Telefone: ${telefone}, Email: ${email}, Mensagem: ${mensagem}`,
  //       html: `<p>Nome: ${nome}<br>Telefone: ${telefone}<br>Email: ${email}<br>Mensagem: ${mensagem}</p>`
  //     }
  //   }

  //   const response = await fetch("https://api.resend.com/emails", postInfo);
  //   if (response.ok) {
  //     alert("Email enviado com sucesso!");
  //   } else {
  //     alert("Falha ao enviar email.");
        ...
        <div class="flex flex-col gap-6 justify-between lg:flex-row">
          <div>
            ...
            <div class="flex gap-3 mt-5">
              <a class="block" href="https://www.instagram.com/dramariaclaracouto/" target="_blank">
                <svg
                    width="40"
                    height="40"
                    viewBox="0 0 40 40"
